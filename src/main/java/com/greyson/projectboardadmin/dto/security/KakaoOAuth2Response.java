package com.greyson.projectboardadmin.dto.security;
...
@SuppressWarnings("unchecked") // TODO: Map -> Object 변환 로직이 있어 제네릭 타입 캐스팅 문제를 무시한다. 고려 필요
public record KakaoOAuth2Response(
    ...
    public record KakaoAccount(
            ...
            Profile profile,
            Boolean hasEmail,   // TODO: 해당 파라미터가 실제 동작하는지 확인 필요
